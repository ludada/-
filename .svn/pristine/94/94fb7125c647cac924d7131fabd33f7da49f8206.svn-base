...
- (void)initView {
    ...
    //大外边框
    self.overlayView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.85];
    self.overlayView.userInteractionEnabled = NO;
    self.overlayView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
    [self.view addSubview:self.overlayView];
    
    //滤镜，也就是选取框（为透明色，在照片上面）
    self.ratioView = [[UIView alloc] initWithFrame:self.cropFrame];
    //边线颜色
    self.ratioView.layer.borderColor = [UIColor colorWithRed:37/255.0f green:37/255.0f blue:37/255.0f alpha:1].CGColor;
    //边线宽度
...
#pragma mark - 调用代理方法（点击确定，即确定裁剪，完成裁剪）
